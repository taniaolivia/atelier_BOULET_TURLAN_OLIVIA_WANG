...
--
-- Hôte : mysql
-- Généré le : ven. 05 nov. 2021 à 21:45
...
CREATE TABLE `categorie` (
  ...
  `descriptionCategorie` varchar(255) COLLATE utf8_unicode_ci NOT NULL
...
CREATE TABLE `panier` (
  ...
  `idcommande` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `produit` (
  ...
  `tarifUnitaire` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `lienImage` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(1, 'Filet de poulet Le Gaulois', 'L\'apport énergétique du produit Filet de poulet est de 95 calories (ou 397 KJ) pour une portion d\'environ 100 grammes. Cela représente environ 5% de l\'apport journalier pour un régime moyen à 2000 calories.', '3.50', 'https://media.auchan.fr/MEDIASTEP131876553_512x512/B2CD/', 2, 3),
...
(4, 'Jambon blanc', 'L\'apport énergétique du produit Jambon blanc est de calories (ou KJ) pour une portion d\'environ 100 grammes. Cela représente environ % de l\'apport journalier pour un régime moyen à 2000 calories.', '3.00', 'https://media.auchan.fr/MEDIASTEP131876553_512x512/B2CD/', 2, 1),
(5, 'Pommes bicolores', 'La pomme Gala a une robe bicolore avec une dominante de rouge, sa saveur douce est à la fois sucrée et acide.', '3.00', 'https://media.auchan.fr/MEDIASTEP130374601_512x512/B2CD/', 5, 1),
...
(7, 'Bananes Antilles françaises', 'Choisir La Banane Française cultivée en Guadeloupe et Martinique c\'est soutenir l\'agriculture française ! La Banane Française est clairement identifiable par son ruban bleu, blanc, rouge.', '3.00', 'https://media.auchan.fr/MEDIASTEP67301987_512x512/B2CD/', 5, 3),
(8, 'Avocat bio', 'Très bon mur à point et gouteux', '3.00', 'https://media.auchan.fr/MEDIASTEP82317656_512x512/B2CD/', 5, 4),
(9, 'Carottes fanes ', 'Carottes ultra fraîches, croquantes et très sucrées', '3.00', 'https://media.auchan.fr/MEDIASTEP104759468_512x512/B2CD/', 4, 1),
...
(12, 'Poisson à la Parisienne', 'Portions de bloc de filets de colin d\'Alaska MSC** (poisson) (Theragra chalcogramma) 50%, eau, champignons 8,8%, crème fraîche 8%', '5.00', 'https://media.auchan.fr/MEDIASTEP84621709_512x512/B2CD/', 4, 3),
...
(14, 'Nectar d\'abricot', 'Nectar d\'abricot à base de purée d\'abricot - teneur en fruits : 40% minimum', '2.00', 'https://media.auchan.fr/MEDIASTEP70614685_512x512/B2CD/', 1, 3),
(15, 'Comté AOP affiné 20 mois', 'LAIT cru de vache, ferments lactiques, présure, sel', '5.00', 'https://media.auchan.fr/MEDIASTEP77262201_512x512/B2CD/', 6, 1);
...
(1, 'Ziyi', '61 rue de Boudonville 54000 Nancy France', 'ziyiwang1027@gmail.com', 'btow', 1, '06 25 98 36 93'),
(2, 'Tania', '33 rue de Lavigerie 54000 Nancy France', 'taniaolivia9@gmail.com', 'btow', 1, '06 29 34 97 04'),
(3, 'Clement', '2 Avenue Milton 54000 Nancy France', 'clement.boulet60510@gmail.com', 'btow', 1, '06 18 95 20 52'),
